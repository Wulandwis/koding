...
public class loginAdmin extends javax.swing.JFrame {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(isiPassword, javax.swing.GroupLayout.DEFAULT_SIZE, 83, Short.MAX_VALUE)
    ...
    private void masukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_masukActionPerformed
        String nama = "admin";
        String pswd = "admin";
        if (nama.equalsIgnoreCase(isiUsername.getText()) && pswd.equalsIgnoreCase(isiPassword.getText())){
            lihatAdmin z = new lihatAdmin();
            z.setVisible(true);
            this.dispose();
        }
        else
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        loginPembeli a =new loginPembeli();
        a.setVisible(true);
            this.dispose();
